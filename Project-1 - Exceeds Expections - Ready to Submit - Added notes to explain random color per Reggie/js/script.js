...
//  Treehouse Full Stack Javascript Apprenticeship
    ...
    // Each of the three colorInteger variables below randomly create a number that is used in tandem with the 4th variable to call an HTML/CSS color.
    // Here I am using the RGB Color model that is formatted "rgb(#,#,#)" and pulls a red, green, and blue value for each number then kind of mixes them together to create one color. 
